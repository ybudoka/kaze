...
module.exports = {
  ...
  async executer({ navigateur, v }) {
    ...
    v('son interrupteur d\'époque est complété à huit sans être perdu',
      r.inter.interLen === 8 && r.inter.interPreserve, `len=${r.inter.interLen} garde=${r.inter.interPreserve}`);
