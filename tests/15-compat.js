...
module.exports = {
  ...
  async executer({ navigateur, v }) {
    ...
    v('les nouveaux champs prennent des valeurs sûres',
      r.old.interLen === 5 && !r.old.bracelet && !r.old.palmes && !r.old.grappin,
    ...
    v('son interrupteur d\'époque est complété à cinq sans être perdu',
      r.inter.interLen === 5 && r.inter.interPreserve, `len=${r.inter.interLen} garde=${r.inter.interPreserve}`);
