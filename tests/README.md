...
| `12-carte.js` | § 11 + § 21 l'écran de carte, mesuré sur les **rectangles réellement dessinés** à cinq tailles d'écran. Il montre **deux plans** : la **région actuelle** (grande, lisible) et un **ruban du monde entier** (découvert au fil de l'exploration, région du moment encadrée). On vérifie : les deux plans présents, le ruban remplit la hauteur et la région une vraie part de la largeur, rien hors du canvas, aucun texte sur un autre ni sur une carte, la légende n'annonce que ce qui reste à trouver. |
...
| `20-nues.js` | § 19 la septième région : la **Cité des Nues**. Ruines flottantes séparées par le **vide** du ciel, la **cape des courants** (planer par-dessus le vide d'une île à l'autre — refusée sans vide à franchir), le **boomerang** qui fait tinter les **huit carillons**, l'**arène cernée de vide** qu'on ne rejoint qu'en planant depuis un pas de vent, le **golem-nuage** qui ne cède qu'au marteau, la **Sentinelle du Ciel** (intouchable en rafale, vulnérable entre deux), la musique, la mini-carte, et rien de perdu au rechargement. Atteignabilité mesurée sur les vraies collisions. |
| `21-faille.js` | § 20 la huitième région, le monde final : la **Faille**. Le néant fracturé (basalte, lave, vide), un **sceau** que nul outil ne brise et qui coupe l'arène jusqu'à ce que la Sentinelle tombe, une **gauntlet** de trois paliers (glace/roche/vide), des **échos** des gardiens, et le boss final le **Rongeur d'Étoiles** (carapace de givre que seul le boomerang brise, cœur à nu très entamé) dont la défaite **achève l'aventure** — l'écran de victoire joue le grand travelling des huit mondes. Atteignabilité et bascule en victoire mesurées sur le vrai jeu. |
