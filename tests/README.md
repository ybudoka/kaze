...
| `44-coeurs.js` | § 53 les **cœurs** : l'offre, le plafond et l'ATH. On ramasse réellement tout ce que le monde pose, on abat réellement les six gardiens, on déroule réellement les deux dialogues de récompense — la jauge doit s'arrêter à **un cœur du plafond**, le dernier restant à acheter : aucun conteneur gaspillé, aucun redondant. Et à cinq tailles d'écran, à pleine jauge, les vingt cœurs passent à la ligne sans toucher les rubis, le cadre les contient, le panneau de débug se pose dessous. Les positions sont relevées sur `coeurATH` elle-même — un filtre sur les `drawImage` cachait justement les cœurs qui débordent. |
