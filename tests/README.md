...
|---|---|
| `01-affichage.js` | § 2.1 la manette tient dans l'écran (320 → 414 px) · § 2.3 les boutons ne couvrent plus le HUD  Et § 62 le **sommaire dit la vérité** : chaque fichier de test figure dans ce tableau, aucune ligne ne décrit un fichier disparu, et l'ordre des numéros est tenu — onze fichiers y manquaient. |
...
| `09-gemmes.js` | Les trois gemmes : valeurs (1 / 5 / 20), teintes distinctes, ramassage, rareté croissante — et **frapper un butin le ramasse**, dans les quatre directions, sans l'attraper de trop loin. Et § 50 la **durée de vie des butins** : on fait vieillir la vraie boucle au-delà du seuil et l'on vérifie que **rien de posé dans le monde ne s'évapore** (la cape et les six fleurs de givre disparaissaient en 12,7 s), avec le contrôle à blanc inverse — ce qui tombe d'un monstre doit bien s'effacer. |
| `10-colporteuse.js` | La marchande itinérante : elle s'installe sur une case libre à portée, ne vend que ce que Bran n'a pas, ses capacités survivent au rechargement — et tous les libellés des boutiques sont affichables par la police pixel. § 51 la comparaison de deux rendus **éteint tout ce qui est temporaire** (bandeau, message, état de sauvegarde) et provoque elle-même l'expiration d'un bandeau : sans cela le contrôle rougissait une fois sur deux, sur 2 700 pixels qui n'avaient rien à voir avec la marque cherchée. |
...
| `27-papillons.js` | § 31 le **cabinet des huit** et le filet : un papillon par région et un seul, chacun posé sur un sol praticable hors salle close et **atteignable à pied**, qui ne se prend ni en marchant dessus, ni à l'épée, ni au boomerang — seulement au filet. Huit teintes distinctes, une par monde. |
| `27-icones.js` | § 25 **chaque objet a son dessin** : on compare les IMAGES RENDUES, normalisées sur une même case — deux noms de sprite différents peuvent très bien porter le même dessin. Et § 61 une mesure de **connexité** des icônes, avec son contrôle à blanc, gardée pour ce qu'elle couvre vraiment : elle n'aurait **pas** attrapé le filet ni la baguette mal composés, dont les morceaux se touchaient à 100 %. |
| `28-cimes-enrichies.js` | § 29, 30, 32 et 33 le **peuplement** des régions vides. Mesuré avant correctif : les Cimes étaient la plus vaste région du jeu (5 954 cases praticables) et la plus vide — 6,2 créatures pour mille cases contre 12,9 dans la vallée, aucun personnage, aucun coffre. Chaque faune reste dans sa région, Borve tient le refuge du col, et le Marais comme les Sables cessent d'être des déserts. |
| `29-nage-et-vue.js` | § 28 ce qu'on **voit** et ce que les monstres voient : dans l'eau seuls la tête, les épaules et les bras dépassent (et rien ne subsiste sous la ligne d'eau) ; un mur coupe le regard des créatures et arrête leurs projectiles ; près d'un personnage on est à couvert ; un panneau ne se lit pas sous le nez d'un monstre. Chaque mesure encadrée de son contrôle à blanc. |
| `30-desert-et-etoiles.js` | § 34 à 37 le désert et les étoiles. L'Arène du Colosse était à **zéro case atteignable**, et l'unique gué qui y mène pouvait être coupé par une mare de sables mouvants tirée au hasard ; `tresorSables`, `tresorMarais` et `tresorNues` comptaient au bilan de fin **sans être posés nulle part** — trois « énigmes » sur huit étaient impossibles. |
| `31-gue-panneaux-reprise.js` | § 38 trois culs-de-sac silencieux. Le **sol** n'était pas sauvegardé : le gué comblé au bloc lourd se rouvrait au rechargement, quatre blocs dépensés, et l'Arène du Colosse devenait inatteignable **pour toujours**. On rejoue la solution, on recharge, et l'on vérifie que la réserve se refait sans rien replacer sous les yeux du joueur. |
| `32-reperes-de-quete.js` | § 38 les ramassages de quête **qui ne se voyaient pas** : les six fleurs de givre et les huit papillons, posés à la volée par `perchoirLibre`, étaient les seuls sans repère de carte. Six fleurs blanches sur la neige d'une région de 6 400 cases ne se cherchent pas à l'œil. Mesuré **sous le vrai brouillard**, avec les cloches en témoin — elles, elles restent cachées. |
| `33-ecran-titre.js` | § 39 l'écran-titre **se recouvrait lui-même** : le bloc-titre grandit avec la largeur, le menu avec le nombre d'emplacements occupés, et aucun des deux ne connaissait l'autre — 4 696 px² de recouvrement sur 620×240, 11 792 px² en paysage. Plus le ciel étoilé : les étoiles occupent toute la largeur et toute la hauteur, sans rangée alignée ni pas constant. |
| `34-frontieres.js` | § 40 les **bords du monde** : les huit régions étaient encloses du même rectangle de mur gris tiré au cordeau — on lisait le bord d'une feuille. Chaque région a maintenant sa pierre, son profil dentelé et sa lisière, sans qu'aucun passage ne se ferme, et aucune créature n'est enfoncée dans le sol. |
| `35-ecran-fin.js` | § 42 l'écran de fin **se recouvrait lui-même**, même maladie que le titre au § 39 et jamais soignée ici : le bilan descendait du haut, le menu montait du bas. Sous ~300 px de hauteur interne — un téléphone couché donne 620×180 — « REPRENDRE LA SAUVEGARDE » s'imprimait par-dessus le bilan. La mesure sait dire recouvrement **et** absence de recouvrement. |
...
| `40-panneaux-plantes.js` | § 45 **chaque panneau est planté, visible et lisible** : sur la vraie carte, toute la progression ouverte, chacun des 34 a son poteau (`O.PANNEAU`), se lit depuis au moins une case atteignable **à pied**, et **n'est recouvert par aucun mur** (§ 46 : `murTuile` peint la case entière et efface le poteau — c'est la classe « mur » qui compte, pas la hauteur : un sapin de 26 px ne masque rien, un mur de 20 px efface tout). Réinjection : un panneau jeté au milieu d'un mur de 5 sur 5 doit quand même être planté — avant correctif, `planterPanneaux` renonçait en silence au-delà de son 3 sur 3. |
| `41-cape.js` | § 41 **la cape se porte, elle ne se tient pas** : équipée, elle était dessinée comme un marteau — une icône de 14 px flottant à hauteur de hanche, sans toucher le héros. Elle pend maintenant des épaules et traîne à l'opposé de la marche, mesuré sur les pixels qu'elle ajoute au corps dans les quatre directions. |
| `42-casque-vr.js` | § 49 le **casque VR** : les manettes Touch d'une session WebXR (le joystick est sur les axes 2/3, pas 0/1), le bouton qui n'apparaît que si un casque le propose, le suivi de tête à hystérésis, les shaders réellement compilés sur un vrai contexte WebGL, et le produit de matrices contrôlé à blanc. La session est jouée contre une **maquette fidèle de WebXR** — session, repère, couche, poses, manettes : elle s'ouvre, la boucle de page rend la main, les deux yeux sont dessinés, les manettes alimentent le jeu, tout se défait à la sortie. Plus § 49 le défaut trouvé dans la couche manette existante : **relâcher un bouton n'éteint plus la touche du clavier tenue en même temps**. Et § 55 **on ne s'enferme jamais dans le casque** : ouvrir le coffre-fort quitte la VR, entrer en VR le referme, et les **deux poignées tenues une seconde** font sortir — une seule ne fait rien. Et § 56 l'**habillage** : l'écran est un arc dont tous les sommets sont à distance constante (contrôle à blanc : un plan aurait les coins plus loin), il tient dans une boîte de 3 m × 2 m même avec une toile en portrait, le cadre l'entoure en retrait, la voûte étoilée enveloppe le joueur et suit sa tête sans tourner avec l'écran ; et les deux boutons `QUITTER VR` / `ÉCRAN TITRE` se visent au rayon — la gâchette ne frappe pas quand elle les vise, et l'action part au relâchement. Et § 59 la **pastille** : un seul bouton, en bas à droite hors du champ de jeu, et un viseur qui ne se montre qu'en s'en approchant — mesuré sur les traits réellement posés. |
| `43-pointeur.js` | § 52 un bouton de la manette à l'écran ne se presse qu'**enfoncé**, jamais au survol : le laser d'un casque Quest émet des `pointermove` tactiles sans appui, et traverser la manette déclenchait des attaques. Événements fabriqués avec les champs exacts du casque, état réel de `BTN` mesuré — et le glissement d'un bouton à l'autre, doigt posé, doit continuer de marcher. Et § 54 le **coffre-fort se ferme au doigt** : le verrouillage tactile annulait `touchstart` hors de la manette, ce qui empêche le navigateur de synthétiser le `click` — le panneau de sauvegarde ne répondait à aucun toucher, sur téléphone comme au laser. Mesuré avec un vrai `touchscreen.tap`, et l'on vérifie que le verrouillage tient toujours partout ailleurs. Et § 59 le bouton **ÉCRAN TITRE**, voisin du PLEIN ÉCRAN : il ramène au titre au doigt, et **sauvegarde d'abord** — un doigt qui glisse ne coûte pas la partie. |
| `44-coeurs.js` | § 53 les **cœurs** : l'offre, le plafond et l'ATH. On ramasse réellement tout ce que le monde pose, on abat réellement les six gardiens, on déroule réellement les deux dialogues de récompense — la jauge doit s'arrêter à **un cœur du plafond**, le dernier restant à acheter : aucun conteneur gaspillé, aucun redondant. Et à cinq tailles d'écran, à pleine jauge, les vingt cœurs passent à la ligne sans toucher les rubis, le cadre les contient, le panneau de débug se pose dessous. Les positions sont relevées sur `coeurATH` elle-même — un filtre sur les `drawImage` cachait justement les cœurs qui débordent. Et § 60 les **cœurs dorés** : au-delà du plafond un conteneur dore un cœur au lieu d'être perdu, un doré tient quatre points et **redevient rouge avant de tomber** — relevé sur ce que l'ATH donne réellement à `coeurATH`, pas sur une copie de la règle. |
| `45-magie.js` | § 57 la **magie** : la fée donne la baguette une fois la lame forgée (dialogue déroulé pour de vrai), le trait coûte un point et ne part pas sans magie, il **passe là où l'épée ricoche** sans percer un gardien cuirassé, il **allume les runes** que nulle lame n'atteint et **dissipe les murs illusoires** que le marteau ne brise pas, les quatre runes ouvrent la Crypte du Lagon — chaque usage encadré de son contrôle à blanc. Et § 60 la **signalisation** : avant la baguette on ne la promet pas, l'épée forgée le journal et l'objectif renvoient à la fée, et le repère des runes traverse le brouillard — mesuré en écartant deux contaminations, la jauge de magie et la légende, toutes deux de la même teinte. |
| `46-tuiles-visibles.js` | § 58 **toute tuile posée se voit** : la table `O` entière est balayée, chaque tuile dessinée par le vrai `decorTuile` et ses pixels comptés. Sept ne dessinaient rien (carillon, carillon sonné, colonne d'air, obélisque, sceau, éclats noirs). Contrôle à blanc sur la case vide, et une liste d'exceptions courte et justifiée. |
| `47-gardiens.js` | § 63 les **sept gardiens** : l'indice de difficulté croît **strictement** (avant : 17, 15, 19, —, 16, 18, 30 coups d'épée — le deuxième était plus facile que le premier), les points de vie suivent la table au lieu d'être écrits à la main, et chaque règle est éprouvée avec son inverse : le Cœur que **marteler ferme** et qui brûle deux fois plus chaud, le Yéti que **le blizzard dérobe** hors de sa charge, le Léviathan qui ne s'offre qu'à la **résurgence**, et le Rongeur qui **dévore un outil par palier** avant de tout recracher. Les paliers sont franchis pour de vrai — appeler la fonction de vol à la main laissait le contrôle vert. |
